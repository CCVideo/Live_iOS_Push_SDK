...
@property (nonatomic, copy)   CancelActionBlock cancelBlock;//取消按钮回调
...
-(instancetype)initWithAlertTitle:(NSString *)title
                     ...
                     cancelAction:(nullable NSString *)cancel
                        sureBlock:(nullable SureActionBlock)sureBlock
                      cancelBlock:(nullable CancelActionBlock)cancelBlock{
    self = [super init];
    if (self) {
        self.frame = [UIScreen mainScreen].bounds;
        self.titleLabel.text = title;
